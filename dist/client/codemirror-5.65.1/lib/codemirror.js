...
(function (global, factory) {
    ...
    function onFocus(cm, e) {
        ...
        if (!cm.state.focused) {
            ...
            if (!cm.curOp && cm.display.selForContextMenu != cm.doc.sel) {
                ...
                if (webkit) {
                    setTimeout(function () { return cm.display.input.reset(true); }, 20);
                } // Issue #1730
            }
    ...
    function initScrollbars(cm) {
        ...
        cm.display.scrollbars = new scrollbarModel[cm.options.scrollbarStyle](function (node) {
            ...
            on(node, "mousedown", function () {
                if (cm.state.focused) {
                    setTimeout(function () { return cm.display.input.focus(); }, 0);
                }
            });
    ...
    function markText(doc, from, to, options, type) {
        ...
        if (marker.clearOnEnter) {
            on(marker, "beforeCursorEnter", function () { return marker.clear(); });
        }
        if (marker.readOnly) {
            seeReadOnlySpans();
                ...
                if (++read == n) {
                    operation(cm, function () {
                        ...
                        var change = { from: pos, to: pos,
                            text: cm.doc.splitLines(text.filter(function (t) { return t != null; }).join(cm.doc.lineSeparator())),
                            origin: "paste" };
    ...
    function defineOptions(CodeMirror) {
        ...
        function option(name, deflt, handle, notOnInit) {
            ...
            if (handle) {
                optionHandlers[name] =
                    notOnInit ? function (cm, val, old) { if (old != Init) {
                        handle(cm, val, old);
                    } } : handle;
            }
        }
    ...
    function CodeMirror(place, options) {
        ...
        if (ie && ie_version < 11) {
            setTimeout(function () { return this$1.display.input.reset(true); }, 20);
        }
    ...
    function registerEventHandlers(cm) {
        ...
        d.dragFunctions = {
            enter: function (e) { if (!signalDOMEvent(cm, e)) {
                e_stop(e);
            } },
            over: function (e) { if (!signalDOMEvent(cm, e)) {
                onDragOver(cm, e);
                e_stop(e);
            } },
        ...
        CodeMirror.prototype = {
            ...
            addOverlay: methodOp(function (spec, options) {
                ...
                insertSorted(this.state.overlays, { mode: mode, modeSpec: spec, opaque: options && options.opaque,
                    priority: (options && options.priority) || 0 }, function (overlay) { return overlay.priority; });
                this.state.modeGen++;
                regChange(this);
            }),
    ...
    ContentEditableInput.prototype.init = function (display) {
        ...
        on(div, "paste", function (e) {
            ...
            if (ie_version <= 11) {
                setTimeout(operation(cm, function () { return this$1.updateFromDOM(); }), 20);
            }
        });

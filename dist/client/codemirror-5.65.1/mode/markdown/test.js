...
(function () {
    ...
    // TODO: fix to be CommonMark-compliant
    MT("fencedBlockNestedInBlockquote", "[quote&quote-1 > ```]", "[quote&quote-1 > code]", "[quote&quote-1 > ```]", 
    ...
    MT("listCommonMark_MixedIndents", "[variable-2 * list1]", "    [variable-2 list1]", "  [variable-2&header&header-1 # heading still part of list1]", "  [variable-2 text after heading still part of list1]", "", "      [comment indented codeblock]", "  [variable-2 list1 after code block]", "  [variable-3 * list2]", 
    ...
    MT("fencedCodeBlocks_validClosingFence", "[comment ```]", "[comment foo]", 
    ...
    MT("autoTerminateFencedCodeWhenLeavingList", "[variable-2 - list1]", "  [variable-3 - list2]", "    [variable-3&comment ```]", "    [comment code]", "  [variable-3 - list2]", "  [variable-2&comment ```]", "  [comment code]", "[quote&quote-1 > foo]");

...
exports.BranchChunk = exports.LeafChunk = void 0;
...
LeafChunk.prototype = {
    ...
    removeInner(at, n) {
        for (let i = at, e = at + n; i < e; ++i) {
            ...
            (0, line_data_js_1.cleanUpLine)(line);
            (0, operation_group_js_1.signalLater)(line, "delete");
        }
    ...
    maybeSpill() {
        ...
        do {
            ...
            if (!me.parent) { // Become the parent node
                ...
                let myIndex = (0, misc_js_1.indexOf)(me.parent.children, me);

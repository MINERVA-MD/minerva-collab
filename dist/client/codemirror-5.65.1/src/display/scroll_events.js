...
exports.onScrollWheel = exports.wheelEventPixels = void 0;
...
else if (browser_js_1.chrome)
    wheelPixelsPerUnit = -.7;
else if (browser_js_1.safari)
...
function onScrollWheel(cm, e) {
    ...
    if (dy && browser_js_1.mac && browser_js_1.webkit) {
    ...
    if (dx && !browser_js_1.gecko && !browser_js_1.presto && pixelsPerUnit != null) {
        if (dy && canScrollY)
            (0, scrolling_js_1.updateScrollTop)(cm, Math.max(0, scroll.scrollTop + dy * pixelsPerUnit));
        (0, scrolling_js_1.setScrollLeft)(cm, Math.max(0, scroll.scrollLeft + dx * pixelsPerUnit));
    ...
    if (dy && pixelsPerUnit != null) {
        ...
        (0, update_display_js_1.updateDisplaySimple)(cm, { top: top, bottom: bot });
    }

...
exports.getOrder = exports.getBidiPartAt = exports.bidiOther = exports.iterateBidiSections = void 0;
...
function getBidiPartAt(order, ch, sticky) {
    ...
    return found != null ? found : exports.bidiOther;
}
...
let bidiOrdering = (function () {
    ...
    return function (str, direction) {
        ...
        if (direction == "ltr") {
            ...
            if ((0, misc_js_1.lst)(order).level == 1 && (m = str.match(/\s+$/))) {
                (0, misc_js_1.lst)(order).to -= m[0].length;
